...
export const NavMenu = styled('div')(({theme}) => ({
  display: 'flex',
  alignItems: 'center',
  background: theme.palette.mode === 'dark' ? '#303136' : 'rgb(225,225,225)',
  borderRadius: '50px',
  // boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px inset',
  // boxShadow: 'rgba(0, 0, 0, 0.10) 0px 10px 20px inset, rgba(0, 0, 0, 0.10) 0px 6px 6px inset',
  height: '35px',
  '@media screen and (max-width: 768px)': {
    display: 'none',
  },
